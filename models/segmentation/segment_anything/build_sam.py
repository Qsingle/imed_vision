...
def build_sam_vit_h(checkpoint=None, encoder_adapter=False):
    return _build_sam(
...
def build_sam_vit_l(checkpoint=None, encoder_adapter=False):
    return _build_sam(
...
def build_sam_vit_b(checkpoint=None, encoder_adapter=False):
    return _build_sam(
...
def build_sam_med_2d(checkpoint=None, encoder_adapter=True):
    return _build_sam(
        encoder_embed_dim=768,
        encoder_depth=12,
        encoder_num_heads=12,
